	 ...
	 if (mysqli_num_rows($result) > 0) {
      ...
      //events selected
         ...
         echo "
               ...
               <table width='30%'>
	          <tr>
	          <th align='center' style='padding-right:25px'><label for='public'><h3>Public</h3></label></th>
	          <th align='center' style='padding-left:10px'><label for='private'><h3>Private</h3></label></th>
		  <th align='center' style='padding-left:25px'><label for='social'><h3>Social Media</h3></label></th>
	          </tr>
                  <tr>
		     <td align='center' style='padding-right:25px'><input type='checkbox' name='public' value ='1'></td>
                     <td align='center' style='padding-left:10px'><input type='checkbox' name='private' value ='1'></td>
                     <td align='center' style='padding-left:25px'><input type='checkbox' name='social' value ='1'></td>
                  </tr>
               </table>

               <p><label for='event_name'><h3>Event Name:</h3></label></p>
	       <p><input type='text' name='event_name' size='20' value='' required></p>

               <p><label for='flier'><h3>Flier Name:</h3></label></p>
	       <p><input type='text' name='flier' size='20' value='' required></p>

	       <p><label for='event_message'><h3>Event Message:</h3></label></p>
      ...
      //notifications selected
         ...
         echo "
	          ...
	          <th align='center' style='padding-right:25px'><label for='public'><h3>Public</h3></label></th>
	          <th align='center' style='padding-left:10px'><label for='private'><h3>Private</h3></label></th>
		  <th align='center' style='padding-left:25px'><label for='email'><h3>Email</h3></label></th>
	          </tr>
                  <tr>
		     <td align='center' style='padding-right:25px'><input type='checkbox' name='public' value ='1'></td>
                     <td align='center' style='padding-leftt:10px'><input type='checkbox' name='private' value ='1'></td>
                     <td align='center' style='padding-left:25px'><input type='checkbox' name='email' value ='1'></td>
                  </tr>
               </table>

               <p><label for='subject'><h3>Subject:</h3></label></p>
	       <p><input type='text' name='subject' size='20' value='' required></p>

	       <p><label for='notification_message'><h3>Message:</h3></label></p>
      ...
      //processing updates
         ...
         if (isset($_POST['updbox'])) {
            $upd = $_POST['updbox'];
            if (isset($_POST['actbox'])) {
               $status = $_POST['actbox'];
            }
            if (isset($_POST['admbox'])) {
               $admin = $_POST['admbox'];
            }
